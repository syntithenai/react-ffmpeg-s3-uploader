  ...
  constructor(props) {
    ...
    onChange(e) {
        ...
        if (file && this.isWorkerLoaded()) {
            console.log(['CHEKC FILE LENG',file.size,file,this.props.fileSizeLimit]);
  ...
  render() {
     let video='';
      ...
      <div>
        ...
        {!(this.isPreview()|| this.state.active) && this.isWorkerLoaded() && <span><b>URL</b> <input size="100" type='text' onBlur={this.updateExternalUrl} defaultValue='' /><br/>or <input type="file" onChange={this.onChange} accept="audio/*,video/*,image/*" /></span>}
        ...
        {<div style={{marginLeft:'0.5em',marginRight:'0.5em'}}><div id="wave-timeline" ></div>
